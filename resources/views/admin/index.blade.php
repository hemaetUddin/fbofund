...
@section('body-content')
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                ...
                                <h4>USD {{ $dasboardDetails['totDeposit'] }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-3">
            <a href="{{ url('admin/totalwithdrawl')}}">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                ...
                                <h4>USD {{ $dasboardDetails['totWithdReq'] }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <tbody>
                {{--*/ $i=1 /* --}}  <!-- don't delete it -->
                @foreach($supportTickets as $support)
                <tr>
                    <td>{{ $i++ }}</td>
                    <td> {{ FindUserName::userName($support->user_id) }} </td>
                    <td> {{ str_limit($support->subject,30) }} </td>
                    {{-- <td> {{ str_limit($support->problem_details,50) }} </td> --}}
                    <td> 
                        @if ($support->status==0)
                            {{ 'Pending' }} 
                        @else 
                    ...
                    <td>
                        <a href="{{ url('/admin/support/view/'.$support->subject )}}" class="btn btn-md btn-info">View</a>
